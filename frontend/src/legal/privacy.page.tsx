		...
		<div className="min-h-[calc(100vh-105px)] flex flex-col items-center px-8 py-16">
			<div className="max-w-2xl w-full">
				...
				<div className="space-y-6 text-foreground/80 text-base leading-relaxed">
					<p>
						DiffEd is a non-commercial educational project. We collect the minimum data needed to run the service and we
					...
					<section>
						...
						<ul className="list-disc pl-6 space-y-1">
							...
							<li>Your avatar image, only if you decide to upload one.</li>
					...
					<section>
						...
						<ul className="list-disc pl-6 space-y-1">
							...
							<li>
								No marketing or notification emails. We don't send email at all - addresses are only stored and used for
								login, as required by our education's project assignment.
							</li>
						</ul>
					</section>
					...
					<section>
						...
						<p className="mt-3">
							Anyone in your workspace can see your username, avatar image, and the live contents of any file you have
							open there. The workspace link is the only thing controlling access - it's almost unguessable, and anyone
							you share it with can join.
						</p>
					</section>
