				...
				<div className="space-y-6 text-foreground/80 text-base leading-relaxed">
					...
					<section>
						...
						<p>
							...
							people. Accounts that abuse the service may be suspended or removed without notice, at the discretion the
							project maintainers responsible for hosting the service.
						</p>
					</section>
